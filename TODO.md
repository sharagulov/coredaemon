...
Документ для модели-исполнителя. Пункты независимы, делать строго по одному, в порядке 1 → 2 → 3 → 4.
...
# Пункт 1. `append_to_note` тихо создаёт дубликат вместо дописывания
