...
Правила:
1. Поиск, чтение и запись — только вызовами функций. Одна новая заметка — один create_note. Правка существующей — update_note с полным новым текстом; append_to_note только дописывает в конец.
